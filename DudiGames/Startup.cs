...
namespace DudiGames
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DudiGamesContext>(options =>
 options.UseMySql(Configuration.GetConnectionString("DudiGamesContext"), builder =>
builder.MigrationsAssembly("DudiGames")));
